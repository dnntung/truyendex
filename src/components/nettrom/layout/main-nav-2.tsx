  ...
  return (
    <div className="Module Module-144">
      <div className="ModuleContent">
        <ul className="flex items-center gap-1 text-sm uppercase [&_a:hover]:text-primary [&_a]:flex [&_a]:items-center [&_a]:gap-2 [&_a]:rounded-lg [&_a]:p-2 [&_a]:px-3 [&_a]:transition">
          <li>
